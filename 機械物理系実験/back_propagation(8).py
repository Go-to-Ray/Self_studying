...
from eight_layer_net import EightLayerNet


#データ読み込み
(x_train, t_train),(x_test, t_test) = load_mnist(normalize=True, one_hot_label=True)
#ネットのサイズを決める
network = EightLayerNet(input_size=784,hidden_size=32,output_size=10)
...
for i in range(iters_num):
    ...
    for key in {"W1","b1","W2","b2","W3","b3","W4","b4","W5","b5","W6","b6","W7","b7","W8","b8"}:
