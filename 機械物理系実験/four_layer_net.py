...
class FourLayerNet:
    ...
    def __init__(self, input_size, hidden_size, output_size,weight_multi = 0.01):
        ...
        self.params["W2"] = np.random.randn(hidden_size, hidden_size*2)/np.sqrt(hidden_size*2)*np.sqrt(2)
        self.params["W3"] = np.random.randn(hidden_size*2, hidden_size*2)/np.sqrt(hidden_size*2)*np.sqrt(2)
        self.params["W4"] = np.random.randn(hidden_size*2, output_size)/np.sqrt(hidden_size)*np.sqrt(2)
